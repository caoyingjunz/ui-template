...
// 辅助函数：创建面包屑项目
const createBreadcrumbItem = (route, index) => {
...
function __VLS_template() {
    ...
    for (const [item, index] of __VLS_getVForSourceType((__VLS_ctx.breadcrumbItems))) {
        __VLS_elementAsFunction(__VLS_intrinsicElements.li, __VLS_intrinsicElements.li)({ key: ((item.key)), ...{ class: ("box-border flex-c h-7 text-sm leading-7") }, });
